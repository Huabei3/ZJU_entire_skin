...
uicontrol('Style','Text', 'HandleVisibility','off','Position',[1190,450,100 ,50],'BackgroundColor',[0.3,0.3,0.3],'Value',0,'String',[num2str(handles.save),'out of 102 images'], 'Tag','text1','FontSize',12)
%  handles.co = handles.co +1; 
%  if handles.co ==91 
%     handles.co = 1;end
imshow([num2str(random_arr(handles.co)),'.bmp']);
