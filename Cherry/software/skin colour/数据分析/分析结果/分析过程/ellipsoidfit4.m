function [par,r,y] = ellipsoidfit4(cielab,zscore,colorcenter)
...
if nargin < 3
    ...
    f = @(a,xdata)(1./(1+a(7)*exp(sqrt(a(1)*(xdata(:,1)-a(4)).^2+a(2)*(xdata(:,3)-a(5)).^2+(xdata(:,2)-a(6)).^2+a(3)*(xdata(:,3)-a(5)).*(xdata(:,2)-a(6)))))).*((a(1)*(xdata(:,1)-a(4)).^2+a(2)*(xdata(:,3)-a(5)).^2+(xdata(:,2)-a(6)).^2+a(3)*(xdata(:,3)-a(5)).*(xdata(:,2)-a(6)))>=0);
    ...
    for t = 1:100
        ...
        a = lsqcurvefit(f,a0,xdata,ydata,[-inf,-inf,-inf,0,0,0,-inf],[inf,inf,inf,inf,inf,inf,inf],options);
        y = (1./(1+a(7)*exp(sqrt(a(1)*(xdata(:,1)-a(4)).^2+a(2)*(xdata(:,3)-a(5)).^2+(xdata(:,2)-a(6)).^2+a(3)*(xdata(:,3)-a(5)).*(xdata(:,2)-a(6)))))).*((a(1)*(xdata(:,1)-a(4)).^2+a(2)*(xdata(:,3)-a(5)).^2+(xdata(:,2)-a(6)).^2+a(3)*(xdata(:,3)-a(5)).*(xdata(:,2)-a(6)))>=0);
   ...
   scatter(ydata,y);
    ...
    for t = 1:100
        ...
        options = optimset('MaxFunEvals',200000);
        a = lsqcurvefit(f,a0,xdata,ydata,[-inf,-inf,-inf,-inf,-inf,-inf,-inf,-inf,-inf],[inf,inf,inf,inf,inf,inf,inf,inf,inf],options);
