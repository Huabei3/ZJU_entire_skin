function JAB = XYZ2CAM16UCS3(XYZ,XYZw,La,Yb,surround)
%%% CAM16-UCS developed by MUHAMMAD SAFDAR on 2017.03.14, Email: msafdar87@hotmail.com %%%

[J,Q,C,M,s,h,H]= CAM16_frwd(XYZ,XYZw,La,Yb,surround);
JMh = [J' M' h'];
JAB = JMh2Jab(JMh);
end
...
D_pre =  1; % D is degree of adoptation; If D is greater than one or less than zero,set it to one or zero accordingly.
if D_pre<0
    D = 0;
elseif D_pre>1
    D = 1;
