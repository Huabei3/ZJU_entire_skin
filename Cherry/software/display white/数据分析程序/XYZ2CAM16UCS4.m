function JAB = XYZ2CAM16UCS4(XYZ,XYZw,La,Yb,surround,d)
%%% CAM16-UCS developed by MUHAMMAD SAFDAR on 2017.03.14, Email: msafdar87@hotmail.com %%%

[J,Q,C,M,s,h,H]= CAM16_frwd(XYZ,XYZw,La,Yb,surround,d);
JMh = [J' M' h'];
JAB = JMh2Jab(JMh);
end

function [J,Q,C,M,S,h,H]= CAM16_frwd(XYZ,XYZw,La,Yb,Surround,d)
%%% XYZ is test XYZ [nx3]
...
D_pre =   d; % D is degree of adoptation; If D is greater than one or less than zero,set it to one or zero accordingly.
if D_pre<0
    D = 0;
elseif D_pre>1
    D = 1;
