...
set(handles.button2,'visible','on');
    ...
    handles.hBtnGrp = uibuttongroup('Position',[ 0.5 0.20 0.25 0.1], 'Units','Normalized','BackgroundColor',[0.5,0.5,0.5]);
    uicontrol('Style','Radio', 'Parent',handles.hBtnGrp, 'HandleVisibility','off','BackgroundColor',[0.5 , 0.5 , 0.5], 'Position',[110,10,20,20],'Value',0, 'String',vec_A(handles.att),'FontSize',20,'FontWeight','bold', 'Tag','A')
    uicontrol('Style','Radio', 'Parent',handles.hBtnGrp, 'HandleVisibility','off','BackgroundColor',[0.5 ,0.5  ,0.5], 'Position',[135,10,20,20],'Value',0, 'String',vec_B(handles.att),'FontSize',20,'FontWeight','bold', 'Tag','B')
     text2 = uicontrol('Style','Text', 'HandleVisibility','off','Position' ,[pos1+270+295, pos2-45,120 ,30],'Value',0,'String','Attractive','FontSize',12,'BackgroundColor',[0.5,0.5,0.5]);
 text3 = uicontrol('Style','Text', 'HandleVisibility','off','Position' ,[pos1+365+295, pos2-45,150 ,30],'Value',0,'String','Unattractive','FontSize',12,'BackgroundColor',[0.5,0.5,0.5]);
 text4 = uicontrol('Style','Text', 'HandleVisibility','off','Position' ,[pos1+300+295, pos2-70,12 ,30],'Value',0,'String','3','FontSize',15,'BackgroundColor',[0.5,0.5,0.5]);
 text5 = uicontrol('Style','Text', 'HandleVisibility','off','Position' ,[pos1+325+295, pos2-70,12 ,30],'Value',0,'String','2','FontSize',15,'BackgroundColor',[0.5,0.5,0.5]);
...
handles.sd(handles.save,2) = data;
...
uicontrol('Style','Text', 'HandleVisibility','off','Position',[1190,450,100 ,50],'BackgroundColor',[0.3,0.3,0.3],'Value',0,'String',[num2str(handles.save),'out of 48 images'], 'Tag','text1','FontSize',12)
%  handles.co = handles.co +1; 
%  if handles.co ==91 
%     handles.co = 1;end
imshow([num2str(random_arr(handles.co)),'.bmp']);
