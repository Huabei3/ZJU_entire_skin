...
for i=1:24
uv_vwpn(i,1:2)=CCT2uv(p_n_vs(i,1),p_n_vs(i,2));
uv_vwpn(i,3:4)=CCT2uv(p_n_vs(i,3),p_n_vs(i,4));
hold on
plot(uv_vwpn(i,1),uv_vwpn(i,2),'o','color',[0    0.4392    0.7529],'LineWidth',2,'MarkerSize',6);
plot(uv_vwpn(i,3),uv_vwpn(i,4),'o','color',[0.7725    0.3529    0.0667],'LineWidth',2,'MarkerSize',6);
plot([uv_vwpn(i,1);uv_vwpn(i,3)],[uv_vwpn(i,2);uv_vwpn(i,4)],'Color',[0.2 0.2 0.2],'LineWidth',1);
end
...
hold off
print(1,'-dbmp',strcat('D:\owncloud\PhD\Graduation Project\Experiment\plot\plot410\','p_n_vs'));
