...
for i=1:24
uv_vwpn(i,1:2)=CCT2uv(d_v_m(i,1),d_v_m(i,2));
uv_vwpn(i,3:4)=CCT2uv(d_v_m(i,3),d_v_m(i,4));
hold on
plot(uv_vwpn(i,1),uv_vwpn(i,2),'x','color',[ 0    0.5    0],'LineWidth',2,'MarkerFaceColor','k','MarkerSize',8);
...
text(uv4(1,1),uv4(1,2),'0.01','FontSize',22,'color',[0.5 0.5 0.5]);
text(uv5(1,1),uv5(1,2),'3000K','FontSize',22,'color',[0.5 0.5 0.5]);
...
text(uv10(1,1),uv10(1,2),'10000K','FontSize',22,'color',[0.5 0.5 0.5]);
hold off
print(1,'-dbmp',strcat('D:\owncloud\PhD\','d_m_10'));
