...
hold on
plot(uv_vwpn(i,5),uv_vwpn(i,6),'x','color',[ 0    0.6902    0.3137],'LineWidth',2,'MarkerFaceColor','k','MarkerSize',8);
plot(uv_vwpn(i,7),uv_vwpn(i,8),'o','color',[0.9 0.2 0.2],'LineWidth',2,'MarkerSize',6);
plot([uv_vwpn(i,5);uv_vwpn(i,7)],[uv_vwpn(i,6);uv_vwpn(i,8)],'Color',[0 0 0],'LineWidth',1);
end
...
hold off
print(1,'-dbmp',strcat('D:\owncloud\PhD\Graduation Project\Experiment\plot\plot410\','v_w_n'));
