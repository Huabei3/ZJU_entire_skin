...
img2=imread(strcat('./OPPO-image3/skin/',num2str(j),'-1.png'));
[~,~,idx2]=imread(strcat('./OPPO-image3/skin/',num2str(j),'-1.png'));
idx2(idx2>0)=1;
img3=imread(strcat('./OPPO-image3/skin/',num2str(j),'-2.png'));
[~,~,idx3]=imread(strcat('./OPPO-image3/skin/',num2str(j),'-2.png'));
idx3(idx3>0)=1;
...
imwrite(rimg,strcat('./image_effect2/new/new_image_',num2str(j),'_',num2str(i),'.jpg'));
P = imresize(rimg,4); 
p=subplot(6,8,i);  
