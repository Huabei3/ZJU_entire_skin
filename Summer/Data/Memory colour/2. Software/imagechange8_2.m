...
y(:,3)=y(:,3).*n(j,3);
xx=x(j,1:3);
img2=imread(strcat('./OPPO-image1/',num2str(j),'-1.png'));
[~,~,idx2]=imread(strcat('./OPPO-image1/',num2str(j),'-1.png'));
idx2(idx2>0)=1;
img3=imread(strcat('./OPPO-image1/',num2str(j),'-2.png'));
[~,~,idx3]=imread(strcat('./OPPO-image1/',num2str(j),'-2.png'));
idx3(idx3>0)=1;
...
% imwrite(rimg,'./image_effect2/image_a.png');
% [~,~,idx1]=imread('./image_effect2/image_a.png');
% idx1(idx1<10)=2;
