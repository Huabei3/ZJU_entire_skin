...
f2=ciecat02_d(xyz,f1(i,:)./f1(i,2).*314.7,f1(4,:),'CAT16',100,100,dd(i)); 
...
%=============================画椭圆===================================
subplot(2,2,1);
subplot('position', [0.09 0.58 0.38 0.37]); 
...
h1=ezplot(f1,[-100,120]);set(h1,'linewidth',2,'Color',color(il,:));hold on;
...
%=============================画椭圆===================================
subplot(2,2,2);
subplot('position', [0.56 0.58 0.38 0.37]); 
plot([-10,50], [-10,50],'color',[0.7,0.7,0.7]);hold on;
for il=1:5
...
%=============================画椭圆===================================
subplot(2,2,3);
subplot('position', [0.09 0.09 0.38 0.37]); 
plot([-10,50], [-10,50],'color',[0.7,0.7,0.7]);hold on;
for il=1:5
...
%=============================画椭圆===================================
subplot(2,2,4);
subplot('position',[0.56 0.09 0.38 0.37]); 
plot([-10,50], [-10,50],'color',[0.7,0.7,0.7]);hold on;
for il=1:5
