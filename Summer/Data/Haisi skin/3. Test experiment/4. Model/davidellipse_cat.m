...
%D=[0.460 	0.521 	0.564 	0.597 	0.623]; 
%  D=[0.06 	0.15 	0.27 	0.47 	0.62 ];
%   D=[0.397751363140676,0.433488054607509,0.460830562552477,0.483808695652174,0.503033179994127];
% D=[0.503 	0.551 	0.588 	0.618 	0.644];
 D=[0.400022155398037,0.435962870307167,0.463461478673384,0.486570795652174,0.505905034011941];
...
sgtitle('Preferred skin color centers (David model) on CIELAB (CAT D=Zhai)');
