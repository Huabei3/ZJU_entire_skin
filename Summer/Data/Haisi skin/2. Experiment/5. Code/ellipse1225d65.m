...
P=s(2:3,2:3);
[h] = ellipsefig1225d65(M(2:3),P,r,1,il,ii); % 绘制置信椭圆
axis([10 26 10 26]);hold on;grid on;
 set(gca,'XTick',[10:2:26]);%设置要显示坐标刻度
 set(gca,'YTick',[10:2:26]);%设置要显示坐标刻度
xlabel('a*','FontSize',15);
ylabel('b*','FontSize',15);
plot(M(2),M(3),obj1(il),'Color',color(il-11+ii*11,:)./255,'MarkerFaceColor',color(il-11+ii*11,:)./255,'MarkerSize',5);
end
end