function lab = meancolor(imgname,ori_imgname,imgclass)
...
if imgclass(1)==1
    ...
    xyzt = xyz0(index , :);
    lab(1,:) = mean(xyz2lab(xyzt,display_f([1 1 1])),1);
...
if imgclass(2)==1
    ...
    xyzt = xyz0(index , :);
lab(2,:) = mean(xyz2lab(xyzt,display_f([1 1 1])),1);
...
if imgclass(3)==1
    ...
    xyzt = xyz0(index , :);
lab(3,:) = mean(xyz2lab(xyzt,display_f([1 1 1])),1);
