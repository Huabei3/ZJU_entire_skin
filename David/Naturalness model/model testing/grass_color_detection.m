function grass_color_detection(imgnumber,classnumbers)
...
r = grass_ellipsoid(center);
index = r;
filename = [int2str(imgnumber),'_grass'];
save(filename,'index');
lab1 = lab0;
for k = 1:classnumber
    if r(k,:) == 1
...
imwrite(result,[int2str(imgnumber),'_',int2str(classnumbers),'grass.jpg']);
