function [par,r,y] = my_ellipsoidfit_4(cielab,zscore,colorcenter)
...
for t = 1:400
    ...
    a = lsqcurvefit(f,a0,xdata,ydata, ...
        [0,0,0,-inf,colorcenter(1)-5,colorcenter(2)-5,colorcenter(3)-5,-inf], ...
        [inf,inf,inf,inf,colorcenter(1)+5,colorcenter(2)+5,colorcenter(3)+5,1],options);
    y = (1./(1+a(8)*exp(a(1)*sqrt((xdata(:,1)-a(5)).^2+a(2)*(xdata(:,2)-a(6)).^2+ ...
    a(3)*(xdata(:,3)-a(7)).^2 +a(4)*(xdata(:,2)-a(6)).*(xdata(:,3)-a(7))))))...
.*(a(1)*(xdata(:,1)-a(5)).^2+(a(2)*(xdata(:,2)-a(6)).^2+a(3)*(xdata(:,3)-a(7)).^2+ ...
a(4)*(xdata(:,2)-a(6)).*(xdata(:,3)-a(7)))>=0);
