function plot_contour_with_scatter3Ddavid(par, lab_group, MSV_group,save_folder,label)
    % 绘制等高线
        % 绘制等高线
    %--------------------a-b---------------------
    ...
    a = par;
    % 计算 y 的值
    % y = (1./(1 +exp(sqrt(a(2) * (data2 - a(6)).^2 + a(3) * (data3 - a(7)).^2 + ...
    %     a(4) * (data2 - a(6)) .* (data3 - a(7))-a(8))))).*((a(2) * (data2 - a(6)).^2 + ...
    %     a(3) * (data3 - a(7)).^2 + a(4) * (data2 - a(6)) .* (data3 - a(7))) >= 0);
    y = (1./(1+exp(sqrt(a(2)*(data2-a(6)).^2+ ...
        a(3)*(data3-a(7)).^2+ ...
        a(4)*(data2-a(6)).*(data3-a(7)))-a(8))))...
    .*((a(2)*(data2-a(6)).^2+ ...
    a(3)*(data3-a(7)).^2+ ...
    a(4)*(data2-a(6)).*(data3-a(7)))>=0);

    figure(1);hold on;
    contour(data2, data3, y, [0.5*max(max(y)), 1], 'Linewidth', 2);
    hold on;
    ...
    % y = (1./(1 + exp(sqrt(a(2) * (data2 - a(6)).^2 + ...
    %     a(1) * (data1 - a(5)).^2)-a(8)))).*((a(2) * (data2 - a(6)).^2 + ...
    % a(1) * (data1 - a(5)).^2) >= 0);
    y = (1./(1+exp(sqrt(a(2)*(data2-a(6)).^2+ ...
        a(1)*(data1-a(5)).^2)-a(8))))...
    .*((a(2)*(data2-a(6)).^2+ ...
    a(1)*(data1-a(5)).^2)>=0);
    figure();hold on;
    contour(data2, data1, y, [0.5*max(max(y)), 1], 'Linewidth', 2);
    hold on;
