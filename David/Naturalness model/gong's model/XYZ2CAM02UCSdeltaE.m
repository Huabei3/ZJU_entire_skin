function deltaE= XYZ2CAM02UCSdeltaE(XYZ1,XYZw1,La1,Yb1,surround1,XYZ2,XYZw2,La2,Yb2,surround2);
...
KL=1;
deltaE = ((((Jab1(:,1)-Jab2(:,1))./KL).^2)+(Jab1(:,2)-Jab2(:,2)).^2+(Jab1(:,3)-Jab2(:,3)).^2).^0.5;
end